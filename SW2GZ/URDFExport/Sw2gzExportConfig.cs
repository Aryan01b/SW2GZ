...
namespace SW2GZ.URDFExport
{
    ...
    public sealed class Sw2gzExportConfig
    {
        ...
        // ALWAYS baked directly into the exported geometry (Robot mode:
        // base_link's mesh reference frame; World mode: each model's
        // &lt;pose&gt;; Asset mode: mesh vertices) — every export ships in
        // REP-103 Z-up regardless of the source assembly's native axes, with
        // no opt-in flag.
