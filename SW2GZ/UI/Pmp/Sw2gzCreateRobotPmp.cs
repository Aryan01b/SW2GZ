...
Steps map to Sw2gzDoc.Robot:
    ...
    1 — Joints   (one row per non-root link; edit type/axis/limit for the
                  selected row — see Sw2gzCreateRobotPmp.Joints.cs)
...
{
    [ComVisible(true)]
    public sealed partial class Sw2gzCreateRobotPmp : PropertyManagerPage2Handler9
    {
        ...
        // Joints step (IdJointsGroup..IdJointLimitUpperBox) is declared in
        // Sw2gzCreateRobotPmp.Joints.cs.
