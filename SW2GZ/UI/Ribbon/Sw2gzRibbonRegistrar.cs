...
namespace SW2GZ.UI.Ribbon
{
    internal sealed class Sw2gzRibbonRegistrar
    {
        ...
        public void Register()
        {
            ...
            // Robot cluster removed for the v2 rebuild — robot mode is a stub
            // (Create Robot shows a not-implemented message). No Sensors /
            // Actuation / Inertia / Stack buttons until robot mode is rebuilt.
        ...
        // Robot cluster emptied for the v2 rebuild — robot mode shows only the
        // Create/Edit Robot button + mode pills, no cluster buttons.
        private static readonly int[] RobotClusterUserIds = new int[0];
